...
class UpdatePage(ctk.CTkFrame):
    ...
    def __init__(self, master, app: CleanerAppProtocol):
        ...
        self.analyze_btn = ctk.CTkButton(
            bar, text=t("btn.analyze"), width=110, command=self.analyze
        )
        self.analyze_btn.pack(side="left")
        self.clean_btn = ctk.CTkButton(
            bar,
            text=t("btn.clean_updates"),
            width=190,
            fg_color=ORANGE,
        ...
        self.size_lbl = ctk.CTkLabel(bar, text=t("label.calculating"), text_color=MUTED)
    ...
    def _measure_done(self, size):
        ...
        self.size_lbl.configure(text=t("update.winsxs_size", size=format_size(size)))
